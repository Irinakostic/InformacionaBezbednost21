...
//Klasa koja sadrzi podatke o licu kojem je sertifikat izdat, serijski broj sertifikata, period vazenja sertifikata i pravni kljuc koji je dodeljen.
...
public class SubjectData {
	...
	public String toString() {
		return "SubjectData [x500name=" + x500name + ", serialNumber=" + serialNumber
				+ ", startDate=" + startDate + ", endDate=" + endDate + ", publicKey=" + publicKey + " + ]";
	}
}
